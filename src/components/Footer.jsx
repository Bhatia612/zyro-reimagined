    ...
    <footer className="relative z-30 bg-base text-ink px-8 pt-10 pb-20 border-t-2 border-border">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12">
        <div className="max-w-sm">
          <span className="text-3xl font-display tracking-tight"><img className="w-[15rem]" src={logo} alt="" /></span>
          <p className="color-ink-soft mt-4 leading-relaxed">
        ...
        <div className="flex gap-16 text-sm font-bold">
          <div className="flex flex-col gap-3">
            <span className="text-ink-soft uppercase tracking-widest text-xs mb-2">Shop</span>
          ...
          <div className="flex flex-col gap-3 font-bold">
            <span className="text-ink-soft uppercase tracking-widest text-xs mb-2">About</span>
